...
Extracts and encapsulates logic for comprehensive analysis of security testing results.
Uses reasoning model to analyze all findings and provide final assessment.
"""
...
class ReasoningTool(AgentTool):
    ...
    def execute(self, context: Dict[str, Any] = None, **kwargs) -> Dict[str, Any]:
        ...
        results_summary = self._build_results_summary(context)
        
        # Build checklist progress
        checklist_progress = self._build_checklist_progress(context)
    ...
    def _build_results_summary(self, context: Dict[str, Any]) -> str:
    ...
    def _build_checklist_progress(self, context: Dict[str, Any]) -> str:
