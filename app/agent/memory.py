...
Replaces raw observations with normalized, queryable facts.
Enables auto-learning from failures and hypothesis tracking.

NEW: Integrates LangChain ConversationSummaryBufferMemory for conversation context.
"""
